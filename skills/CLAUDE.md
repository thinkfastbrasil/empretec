...
> **Full rules reference** (G1–G5: Security, Performance, Legacy/Deprecated, Metadata Access, Compilation): read [advpl-tlpp/references/sonarqube-rules-reference.md](advpl-tlpp/references/sonarqube-rules-reference.md) before generating or reviewing code.
...
See [advpl-tlpp/README.md](advpl-tlpp/README.md) for the full catalog. Summary:
...
### Superpowers (generic workflow skills)

Pacote de skills de processo, independentes de linguagem, aplicáveis a qualquer tarefa de desenvolvimento neste projeto (planejamento, debugging, revisão de código, TDD, etc.). Localização: `skills/superpowers/`.

| Category | Skills |
|----------|--------|
| **Planning** | `brainstorming`, `writing-plans`, `executing-plans`, `create-implementation-plan` |
| **Execution** | `dispatching-parallel-agents`, `subagent-driven-development`, `using-git-worktrees` |
| **Debugging & Verification** | `systematic-debugging`, `verification-before-completion` |
